          ...
          "inputs" : {
            ...
            "Parameters" : {
              "commands" : [
                ...
                "$Computers = Get-ADComputer -Filter {(Enabled -eq $False)} -SearchBase 'OU=ekant' -Credential $credential | Select-Object Name, LastLogonDate, Enabled, DistinguishedName",
